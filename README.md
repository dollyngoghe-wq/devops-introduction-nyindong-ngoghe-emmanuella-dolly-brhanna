...
1. 'git init' :  Pour commencer à suivre mon projet
2. 'git add .' : Pour ajouter tous mes fichiers
3. 'git commit -m "premier commit"' : pour enregistrer les modifications
4. 'git push' : Pour envoyer envoyer mon projet sur Github
